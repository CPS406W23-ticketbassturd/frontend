...
const Update = async () => {
    ...
    if (data.success !== false && data.success !== undefined) {
        ...
        alert('Update Failed. Please make sure you have entered a valid email and password and try again.');
    }
...
export default function RegisterPage() {
    return (
        <>
            <Head>
                <title>Update Account | Ticketbass-Turd</title>
            ...
            <main>
                ...
                <Stack alignItems={'center'} justifyContent={'center'} sx={{pt:15, backgroundColor: 'white', p:3, m: '20%', border: '5px solid grey', borderRadius: '25px'}}>
                    <Typography sx={{m:1, color: 'black'}} variant={'h4'}>Update Account</Typography>
